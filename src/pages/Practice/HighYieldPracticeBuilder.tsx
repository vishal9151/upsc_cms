...
import { HighYieldSubtopicSelectionStep } from '@/components/practice/HighYieldSubtopicSelectionStep'
...
import { useHighYieldPracticeBuilder } from '@/hooks/useHighYieldPracticeBuilder'
import { generatePracticeTest } from '@/utils/practiceGenerator'

const STEPS = ['Subjects', 'Topics', 'Years', 'Count'] as const
const LAST_STEP = STEPS.length - 1

export function HighYieldPracticeBuilder() {
  const navigate = useNavigate()
  const [generating, setGenerating] = useState(false)
  const builder = useHighYieldPracticeBuilder()
    ...
    <div className="mx-auto max-w-3xl space-y-6 pb-24 sm:pb-8">
      ...
      <div className="text-center">
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-400">
          Focus on the most exam-relevant topics — ordered by importance, with
      ...
      <Card>
        <div className="space-y-6">
          ...
          {builder.step === 1 && (
            <HighYieldSubtopicSelectionStep
              ...
              onSelectHighYield={builder.selectHighYieldSubTopics}
